...
;(function() {
	...
	function Menu(scene, camera, projector, raycaster) {
		...
		this.createActionMenuItem = function(imageUrl, action) {
			var actionMenuItem = new ActionMenuItem(imageUrl, this.menuItemsCounter++, action)
	...
	function ActionMenuItem(imageUrl, id, action) {
		MenuItem.call(this, imageUrl, id)
		this.action = action
	}
